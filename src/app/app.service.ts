...
export class AppService {
  ...
  public getPanelList(): Observable<Panel[]> {
    return this.httpClient.get<any>(
      `${this.apiPrefix}${this.panelListURL}`,
      httpOptions
    );
  }
  ...
  public getPanelByID(panelID: number): Observable<Panel> {
    return this.httpClient.get<any>(
      `${this.apiPrefix}${this.panelDetailURL}${panelID}`,
      httpOptions
    );
  }
  ...
  public getPanelByName(panelName: string): Observable<Panel> {
    return this.httpClient.get<any>(
      `${this.apiPrefix}${this.panelDetailURL}${panelName}`,
      httpOptions
    );
  }
  ...
  public getParameters(): Observable<Parameter[]> {
    return this.httpClient.get<any>(
      `${this.apiPrefix}${this.parameterURL}`,
      httpOptions
    );
  }
  ...
  public getParameter(id: number): Observable<Parameter> {
    return this.httpClient.get<any>(
      `${this.apiPrefix}${this.parameterDetailURL}/${id}`,
      httpOptions
    );
  }

  public updateParameter(payload: {
    id: number;
    value: number;
  }): Observable<Parameter> {
    return this.httpClient.post<any>(
      `${this.apiPrefix}${this.parameterDetailURL}/${payload.id}`,
      payload,
      httpOptions
    );
  }
  ...
  public createPanel(payload: CreatePanelPayload): Observable<Panel> {
    return this.httpClient.patch<any>(
      `${this.apiPrefix}${this.panelCreateURL}`,
      payload,
      httpOptions
    );
  }
  ...
  public deletePanel(panel_id: number): Observable<any> {
    return this.httpClient.delete<any>(
      `${this.apiPrefix}${this.panelDetailURL}${panel_id}`,
      httpOptions
    );
  }
